...
echo "<td colspan='8'>
    ...
    |<a href='list_4.php?action=top&offset=$offset'>首页</a>
    |<a href='list_4.php?action=pre&offset=$offset'>上一页</a>
    |<a href='list_4.php?action=next&offset=$offset'>下一页</a>
    |<a href='list_4.php?action=bottom&offset=$offset'>尾页</a>
    </td>";
echo "</tr>";
